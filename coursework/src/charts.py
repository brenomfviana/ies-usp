...
def heat_map(hmsga, hmcga, filename, i):
  ...
  heatmap = axis.pcolor(hmsga['i'], vmin=hmmin, vmax=hmmax, cmap=plt.cm.Reds)
  ...
  for arr in hmsga['t']:
    ...
    hmmax = max(hmmax, max(arr))
  fig, axis = plt.subplots(figsize=(6.4, 4.8))
  heatmap = axis.pcolor(hmsga['t'], vmin=hmmin, vmax=hmmax, cmap=plt.cm.Reds)
  plt.colorbar(heatmap, format=ticker.FuncFormatter(_fmt))
  fig.tight_layout()
  ...
  for arr in hmsga['f']:
    ...
    hmmax = max(hmmax, max(arr))
  fig, axis = plt.subplots(figsize=(6.4, 4.8))
  heatmap = axis.pcolor(hmsga['f'], vmin=hmmin, vmax=hmmax, cmap=plt.cm.Reds)
  plt.colorbar(heatmap, format=ticker.FuncFormatter(_fmt))
  fig.tight_layout()
  ...
  for arr in hmcga['i']:
    ...
    hmmax = max(hmmax, max(arr))
  fig, axis = plt.subplots(figsize=(6.4, 4.8))
  heatmap = axis.pcolor(hmcga['i'], vmin=hmmin, vmax=hmmax, cmap=plt.cm.Blues)
  plt.colorbar(heatmap, format=ticker.FuncFormatter(_fmt))
  fig.tight_layout()
  ...
  for arr in hmcga['t']:
    ...
    hmmax = max(hmmax, max(arr))
  fig, axis = plt.subplots(figsize=(6.4, 4.8))
  heatmap = axis.pcolor(hmcga['t'], vmin=hmmin, vmax=hmmax, cmap=plt.cm.Blues)
  plt.colorbar(heatmap, format=ticker.FuncFormatter(_fmt))
  fig.tight_layout()
  ...
  for arr in hmcga['f']:
    ...
    hmmax = max(hmmax, max(arr))
  fig, axis = plt.subplots(figsize=(6.4, 4.8))
  heatmap = axis.pcolor(hmcga['f'], vmin=hmmin, vmax=hmmax, cmap=plt.cm.Blues)
  plt.colorbar(heatmap, format=ticker.FuncFormatter(_fmt))
  fig.tight_layout()
